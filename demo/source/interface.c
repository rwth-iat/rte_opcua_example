...
OV_DLLFNCEXPORT void demo_interface_startup(
		OV_INSTPTR_ov_object 	pobj) {
	/*
	*   local variables
	*/
	OV_INSTPTR_demo_interface pinst = Ov_StaticPtrCast(demo_interface, pobj);
...
OV_DLLFNCEXPORT void demo_interface_shutdown(
		OV_INSTPTR_ov_object 	pobj) {
	/*
	*   local variables
	*/
...
OV_DLLFNCEXPORT OV_BOOL demo_interface_checkNode(
